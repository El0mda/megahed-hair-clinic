        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-xl" style={{ color: '#a8c4e8' }}>
              {isAr ? 'آخر الفيديوهات من د. أحمد مجاهد' : 'Latest videos from Dr. Ahmed Megahed'}
            </p>
          </motion.div>
        </div>
      </section>
              ...
              {posts.map((post, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-5">
                      <span className="text-xs px-2 py-0.5 rounded-full font-medium inline-block mb-3" style={{ background: '#fef3c7', color: '#92400e' }}>
                        {isAr ? 'فيديو' : 'Video'}
                      </span>
