...
function ReviewsSection({ isAr }) {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #0f2347 0%, #1e3a6e 55%, #162d57 100%)",
      }}
    >
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p
                className="text-white/85 text-lg sm:text-xl leading-relaxed mb-8 font-light"
                style={{ fontStyle: "italic", letterSpacing: "0.01em" }}
              >
                "
                {isAr
                  ? review.review_text
                  : review.review_text_en || review.review_text}
                "
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
          ...
          <Link to="/before-after">
            <button
              className="flex items-center gap-2 px-6 py-3 rounded-2xl font-bold text-sm transition-all hover:-translate-y-0.5 active:scale-95"
        ...
        <div className="text-center mt-10">
          <Link to="/before-after">
            <button
              className="inline-flex items-center gap-2 px-8 py-3 rounded-2xl font-bold text-sm border-2 transition-all hover:-translate-y-0.5"
              style={{
                borderColor: "#1e3a6e",
                color: "#1e3a6e",
                background: "white",
  ...
  const services = [
    {
      ...
      titleAr: "الاستشارة",
      image:
        "https://cdn.sanity.io/images/0vv8moc6/dermatologytimes/1ca878c5ecdb8b7791a50524205b27d0f6ad1718-4286x2857.jpg",
      link: "#",
      isModalTrigger: true,
    },
    {
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSslc08kzVICRpcOcBmPr1JoOQr7D2WEHQ_sg&s",
      link: "/services",
    },
    {
      ...
      titleAr: "زراعة الشعر",
      image:
        "https://media.istockphoto.com/id/1265650028/photo/hair-transplant.jpg?s=612x612&w=0&k=20&c=XVJRcIwrSx1x-RgbVPMw0lLcWwhgFnWslLllKN30cdE=",
      link: "/services",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          {isAr
            ? "د. أحمد مجاهد - أخصائي زراعة الشعر"
            : "Dr. Megahed Hair Clinic - Hair Loss Solutions & Hair Transplant Specialist"}
        </title>
      </Helmet>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #162d57 0%, #1e3a6e 50%, #253f7a 100%)",
        }}
        dir={isAr ? "rtl" : "ltr"}
      >
        <div
            ...
            >
              ...
              >
                {isAr
                  ...
                  : "Egypt's first specialized hair clinic."}
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/contact">
                  <Button
                    size="lg"
                    className="font-semibold shadow-xl border-2"
                    style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {credentials.map((item, index) => (
              <motion.div
                ...
                style={{ borderTop: "3px solid #1e3a6e" }}
              >
                <item.icon
                  className="w-10 h-10 mb-4"
                  style={{ color: "#1e3a6e" }}
                />
                <h3 className="text-lg font-bold" style={{ color: "#1e3a6e" }}>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 z-[101]"
              dir={isAr ? "rtl" : "ltr"}
            >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center p-4 border-2 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all text-left"
                >
                  <Stethoscope
                    className={`${isAr ? "ml-4" : "mr-4"} w-8 h-8 text-blue-600`}
                  />
                ...
                >
                  ...
                  />
                  <div className="font-bold">
                    {isAr ? "استشارة أونلاين" : "Online Consultation"}
                  </div>
                </button>
                <button
                  onClick={handleClinicConsultation}
                  className="w-full flex items-center p-4 border-2 border-gray-100 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all text-left"
                >
                  <Building2
                    className={`${isAr ? "ml-4" : "mr-4"} w-8 h-8 text-green-600`}
                  />
