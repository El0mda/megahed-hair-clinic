...
const PROCEDURES = {
  en: [
    ...
    "Scar & Post-Traumatic Hair Transplant",
    "Forehead Reduction / Scalp Advancement Surgery",
    "PRP Therapy",
    "Mesotherapy",
    "Stem Cell Regenerative Therapy",
    "Scalp Micropigmentation (SMP)",
    "Hair & Scalp Diagnosis / Consultation",
  ],
  ar: [
    "زراعة الشعر بتقنية FUE",
    "زراعة الحواجب",
    "زراعة اللحية والشارب",
    "زراعة الشعر في الندبات وما بعد الإصابات",
    "زراعة تصغير الجبهة",
    "علاج البلازما (PRP)",
    "الميزوثيرابي",
    "العلاج بالخلايا الجذعية",
    "تقنية SMP",
    "تشخيص الشعر وفروة الرأس / استشارة",
  ],
};
...
// ─── Input base styles ────────────────────────────────────────────────────────
const inputCls = (err) =>
  `w-full px-4 py-3 rounded-xl border text-sm text-gray-900 transition focus:outline-none focus:ring-2 focus:border-transparent ${
    err
...
function PillButton({ selected, onClick, children }) {
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!selected) {
          e.currentTarget.style.borderColor = "#7a96c2";
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch(
        "https://n8n.srv1116147.hstgr.cloud/webhook/65af3d64-d0d4-4c3f-b8e0-0baebd3f03bd",
        {
          method: "POST",
  ...
  return (
    <>
      <Helmet>
        <title>
          {isAr
            ? "استشارة زراعة الشعر — د. أحمد مجاهد"
            : "Hair Transplant Consultation — Dr. Ahmed Megahed"}
        </title>
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            >
              ...
              >
                {isAr
                  ? "أرسل طلب استشارتك"
                  : "Get your personalised plan and quote"}
              </h2>
              <p className="text-sm mb-8" style={{ color: "#7a96c2" }}>
                {isAr
                  ? "جميع الحقول المعلمة بـ * مطلوبة"
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <input
                      ...
                      placeholder={
                        isAr ? "أدخل اسمك الأول" : "Insert your first name"
                      }
                  ...
                  >
                    <input
                      ...
                      placeholder={
                        isAr ? "أدخل اسم العائلة" : "Insert your last name"
                      }
                ...
                >
                  <input
                    ...
                    placeholder={
                      isAr ? "أدخل بريدك الإلكتروني" : "Insert your email"
                    }
                ...
                {/* Region */}
                <Field
                  label={isAr ? "المنطقة *" : "Your Region *"}
                  error={errors.region}
                >
                  <select
                    value={form.region}
                  ...
                  >
                    <option value="">
                      {isAr ? "اختر منطقتك *" : "Select your region *"}
                    </option>
                    {REGIONS[lang].map((r) => (
                ...
                <Field
                  label={
                    isAr
                      ? "هل خضعت لعملية زراعة شعر من قبل؟ *"
                    ...
                    {[
                      ...
                      <PillButton
                        ...
                        onClick={() =>
                          set(
                            "hairLossDuration",
                            form.hairLossDuration === opt.value
                              ? ""
                              : opt.value,
                          )
                        }
                ...
                <Field
                  label={
                    isAr
                      ? "ما كمية تساقط الشعر يومياً؟ (شعرة في اليوم)"
                      : "How much hair do you shed daily? (hairs/day)"
                  }
                >
                    ...
                    {[
                      ...
                      <PillButton
                        ...
                        onClick={() =>
                          set(
                            "dailyShedding",
                            form.dailyShedding === opt.value ? "" : opt.value,
                          )
                        }
                      >
                        {isAr ? opt.ar : opt.en}
                ...
                {/* Message */}
                <Field
                  label={isAr ? "رسالتك (اختياري)" : "Your Message (optional)"}
                >
                  <textarea
                    value={form.message}
                ...
                <div>
                  ...
                  {/* Photo examples */}
                  <div className="bg-[#1e3a6e]/5 border border-[#1e3a6e]/20 rounded-xl p-4 mb-4">
                  ...
                  <div
                    ...
                    onMouseLeave={(e) => {
                      if (!dragging) {
                        e.currentTarget.style.borderColor = "#c0cfe8";
                        e.currentTarget.style.background = "#f7f9fd";
                      }
                    }}
                  >
                ...
                <button
                  ...
                  style={{ background: "#1e3a6e" }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.background = "#162d57")
                  }
                  onMouseLeave={(e) =>
